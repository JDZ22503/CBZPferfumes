    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content={`Experience the ultimate luxury gifting with ${productSet.name}. A curated collection of fine fragrances from CBZ Perfumes.`} />
            </Head>
                    ...
                    <div className="container mx-auto px-6">
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative aspect-[4/5] bg-zinc-900/50 rounded-[2.5rem] overflow-hidden border border-white/5 backdrop-blur-sm">
                                    {productSet.image_path ? (
                                        <img
                                            src={`${import.meta.env.VITE_API_BASE_URL}${productSet.image_path}`}
                                            alt={productSet.name}
                        ...
                        <div className="mt-32 pt-20 border-t border-white/5">
                            <div className="grid md:grid-cols-2 gap-16">
                                <div className="space-y-4">
                                    <h3 className="text-xl font-bold font-serif text-amber-500">What's Inside</h3>
                                    <p className="text-gray-400 leading-relaxed font-light">Experience the variety of CBZ Perfumes. This set includes a selection of our signature scents, allowing you to discover your new favorite or share the luxury with others.</p>
                                </div>
                                <div className="space-y-4">
                                    <h3 className="text-xl font-bold font-serif text-amber-500">Gifting Perfection</h3>
                                    <p className="text-gray-400 leading-relaxed font-light">Whether for a birthday, anniversary, or a special celebration, our gift sets are designed to leave a lasting impression of sophistication and care.</p>
                                </div>
                            </div>
                        </div>
                    </div>
