...
Product: ${attar.name}
Type: Pure Attar
Price: Rs.${Number(attar.price).toLocaleString()}
SKU: ${attar.sku || 'N/A'}
------------------------------
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content={attar.attar_detail?.description || `Discover the timeless essence of ${attar.name}. A pure, handcrafted attar oil for a lasting and sophisticated presence.`} />
            </Head>
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-16 lg:gap-24 items-start">
                            ...
                            <div className="space-y-10">
                                ...
                                {attar.attar_detail?.description && (
                            ...
                            <div className="grid md:grid-cols-3 gap-16">
                                <div className="space-y-4">
                                    ...
                                    <p className="text-gray-400 leading-relaxed font-light">
                                        {attar.attar_detail?.top_notes || "Handcrafted using age-old distillation techniques to capture the true soul of the ingredients."}
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <h3 className="text-xl font-bold font-serif text-amber-500">Heart Notes</h3>
                                    <p className="text-gray-400 leading-relaxed font-light">
                                        {attar.attar_detail?.heart_notes || "Apply a single drop to pulse points. The warmth of your skin will slowly release the symphony of notes."}
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <h3 className="text-xl font-bold font-serif text-amber-500">Base Notes</h3>
                                    <p className="text-gray-400 leading-relaxed font-light">
                                        {attar.attar_detail?.base_notes || "Keep in its signature packaging away from sunlight to maintain the potency of the precious oils."}
                                    </p>
                                </div>
                            </div>
                        </div>
