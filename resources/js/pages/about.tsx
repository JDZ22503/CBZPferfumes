...
export default function About() {
    return (
        <>
            <Head>
                <title>About Us - The Craftsmanship of CBZ Perfumes</title>
                <meta name="description" content="Discover the story behind CBZ Perfumes. Our journey of crafting exceptional luxury fragrances using traditional distillation and rare ingredients." />
            </Head>
