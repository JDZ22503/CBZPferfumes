...
export default function Edit({ detail }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('gift-set-details.update', detail.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Details - ${detail.product_set.name}`} />
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">
                                Edit Gift Set Details: <span className="font-bold">{detail.product_set.name}</span>
                            </h2>
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="flex items-center">
                                    <input
                                        ...
                                        className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:bg-gray-900 dark:border-gray-600"
                                    />
