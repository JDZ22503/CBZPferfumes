    ...
    const renderTransaction = ({ item }: { item: any }) => {
        ...
        return (
            <TouchableOpacity
                ...
                onPress={() => displayId ? router.push(`/(app)/(tabs)/orders/${displayId}` as any) : null}
            >
                <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4, gap: 8 }}>
                                ...
                                {orderStatus && (
                                    <View style={[styles.statusBadge, { backgroundColor: orderStatus === 'completed' ? '#D1FAE5' : '#FEF3C7' }]}>
                                        <Text style={[styles.statusBadgeText, { color: orderStatus === 'completed' ? '#065F46' : '#92400E' }]}>
                                            {orderStatus.toUpperCase()}
                                        </Text>
                                    </View>
                                )}
                                {paymentStatus && (
                                    <View style={[styles.statusBadge, { backgroundColor: paymentStatus === 'paid' ? '#DBEAFE' : '#FEE2E2' }]}>
                                        <Text style={[styles.statusBadgeText, { color: paymentStatus === 'paid' ? '#1E40AF' : '#991B1B' }]}>
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.headerRow}>
                <Image source={{ uri: getImageUrl(party.image_path) }} style={styles.headerImage} />
