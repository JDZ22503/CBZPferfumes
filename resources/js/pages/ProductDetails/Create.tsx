...
const breadcrumbs = [
    ...
    {
        title: 'Create',
        href: '/cbz-admin/product-details/create',
    },
];
...
export default function Create({ products }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('product-details.store'));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Add Product Details" />

            <div className="py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Add Product Details</h2>
