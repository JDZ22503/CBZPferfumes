...
<head>
    ...
    <style>
        body {
            ...
            font-size: 10px;
            /* Reduced to 10px to fit more */
            margin: 0;
            padding: 10px;
            background: #e0e0e0;
            /* Gray background for web view contrast */
            display: flex;
        ...
        .invoice-wrapper {
            width: 210mm;
            height: 275mm;
            /* Reduced to strictly fit A4 with massive safety margin */
            padding: 5mm;
            margin: 0;
            background: white;
...
<body>
    ...
    <div class="no-print" style="text-align: center; margin-bottom: 20px;">
        <button id="download-pdf"
            style="padding: 10px 20px; background-color: #4f46e5; color: white; border: none; border-radius: 5px; cursor: pointer; font-weight: bold;">
            Download PDF
        </button>
    </div>
                    ...
                    <tr>
                        <td class="left no-border" width="40%">
                            ...
                            <div style="font-weight: bold; font-size: 12px; margin-top: 5px;">
                                {{ $settings['company_name'] ?? 'PERFUME ZONE' }}</div>
            ...
            <div class="footer-section">
                <table class="total-table" style="width: 100%; border-top: 1px solid #000;">
                    <tr>
                        ...
                        <td width="60%"
                            style="padding: 0; vertical-align: top; border-right: 1px solid #000; border-top: none;">
                            <table style="width: 100%; border-collapse: collapse; border: none;">
                                <tr>
                                    <td colspan="4" class="left bold small"
                                        style="border: none; border-bottom: 1px solid #000; padding: 2px 4px;">GST
                                        Summary</td>
                                </tr>
                                <tr class="small bold center">
                                    <td
                                        style="border: none; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                        Sales %</td>
                                    <td
                                        style="border: none; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                        Taxable Amount</td>
                                ...
                                <tr class="small center">
                                    ...
                                    <td
                                        style="border: none; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                        {{ number_format($totalTaxable, 2) }}</td>
                                    <td
                                        style="border: none; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                            ...
                            <div style="padding: 5px; border-top: 1px solid #000; height: 80px;">
                                ...
                                <div class="small">
                                    <strong>Bank :</strong>
                                    {{ $settings['bank_name'] ?? 'Vijay Commercial Co-operative Bank' }}<br>
                                    <strong>A/C No :</strong>
                                    {{ $settings['bank_account_no'] ?? '003002600000214' }}<br>
                        ...
                        <td width="40%" style="padding: 0; vertical-align: top; border-top: none;">
                            <table style="width: 100%; border-collapse: collapse; border: none;">
                                <tr>
                                    <td class="right bold small"
                                        style="border: none; border-bottom: 1px solid #000; padding: 2px 5px;">Sub
                                        Total</td>
                                    <td class="right bold small"
                                        style="border: none; border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px 5px;">
                                        {{ number_format($grandTotal, 2) }}</td>
                                </tr>
                                <tr>
                                    <td class="right small"
                                        style="border: none; border-bottom: 1px solid #000; padding: 2px 5px;">Round
                                        Off</td>
                                    <td class="right small"
                                        style="border: none; border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px 5px;">
                                        0.00</td>
                                ...
                                <tr>
                                    <td class="right bold small" style="border: none; padding: 5px;">Grand Total ₹
                                    </td>
                                    <td class="right bold small"
                                        style="border: none; border-left: 1px solid #000; padding: 5px;">
                                        {{ number_format($grandTotal, 2) }}</td>
                                </tr>
                            </table>
                            ...
                            <div style="border-top: 1px solid #000; display: flex; height: 100px;">
                                <div
                                    style="flex: 1; padding: 5px; display: flex; align-items: center; justify-content: center;">
                                    <!-- QR Placeholder -->
                                    @php
                                        $upiId = $settings['upi_id'] ?? '';
                                        $companyName = $settings['company_name'] ?? 'PERFUME ZONE';
                                        $qrData = !empty($upiId)
                                            ? "upi://pay?pa={$upiId}&pn=" .
                                                urlencode($companyName) .
                                                "&am={$grandTotal}&cu=INR&tn=Order%20{$order->id}"
                                            : url('/orders/' . $order->id);
                                    @endphp
                                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data={{ urlencode($qrData) }}"
                                        alt="Scan URL" style="width: 80px; height: 80px;">
                                    <div class="small center" style="margin-top:2px;">Scan to Pay</div>
                                </div>
                                <div
                                    style="flex: 1.5; text-align: right; padding: 5px; display: flex; flex-direction: column; justify-content: space-between;">
