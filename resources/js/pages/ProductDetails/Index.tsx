...
const breadcrumbs = [
    {
        ...
        href: '/cbz-admin/product-details',
    },
];
...
export default function Index({ details, filters }: Props) {
    ...
    const handleToggleStatus = (id: number) => {
        router.post(route('product-details.toggle-status', id), {}, {
            preserveScroll: true,
        });
    };

    const handleToggleFeatured = (id: number) => {
        router.post(route('product-details.toggle-featured', id), {}, {
            preserveScroll: true,
        });
    };
    ...
    const handleDelete = (id: number) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('product-details.destroy', id), {
                    onSuccess: () => {
                        Swal.fire(
                            'Deleted!',
                            'Product details have been deleted.',
                            'success',
                        );
                    },
                });
            ...
            <div className="py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <Link
                            href={route('product-details.create')}
