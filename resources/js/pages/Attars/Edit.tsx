...
export default function Edit({ attar }: Props) {
    const breadcrumbs = [
        {
            title: 'Attars',
            href: '/attars',
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        name: attar.name,
        price: attar.price,
        cost_price: attar.cost_price,
        hsn_code: attar.hsn_code || '',
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('attars.update', attar.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Attar" />

            <div className="py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Edit Attar: {attar.name}</h2>
                            ...
                            <form onSubmit={submit} className="space-y-6 max-w-2xl">
                                ...
                                <div>
                                    ...
                                    {(data.image || attar.image_path) && (
                                        <div className="mt-2 mb-2">
                                            <img
                                                src={data.image ? URL.createObjectURL(data.image) : attar.image_path!}
                                                alt={attar.name}
