...
export default function Edit({ productSet }: Props) {
    const breadcrumbs = [
        {
            title: 'Gift Sets',
            href: '/product-sets',
        ...
        {
            title: 'Edit',
            href: `/product-sets/${productSet.id}/edit`,
        },
    ];
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        cost_price: productSet.cost_price,
        hsn_code: productSet.hsn_code || '',
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('product-sets.update', productSet.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Product Set" />

            <div className="py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Edit Product Set: {productSet.name}</h2>
                            ...
                            <form onSubmit={submit} className="space-y-6 max-w-2xl">
                                ...
                                <div>
                                    ...
                                    {(data.image || productSet.image_path) && (
                                        <div className="mt-2 mb-2">
                                            <img
                                                src={data.image ? URL.createObjectURL(data.image) : productSet.image_path!}
                                                alt={productSet.name}
