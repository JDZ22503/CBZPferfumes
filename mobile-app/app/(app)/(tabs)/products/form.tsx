...
import { View, ScrollView, StyleSheet, Alert, ActivityIndicator, TouchableOpacity, Text, KeyboardAvoidingView, Platform } from 'react-native';
    ...
    return (
        <>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                <ImagePickerInput imageUri={imageUri} onImageSelected={setImageUri} label="Product Image" name={watch('name')} />
