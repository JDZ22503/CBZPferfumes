...
class StockController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Stock updated successfully', 'current_stock' => $item->stock_quantity]);
    }
    ...
    public function toggleStatus(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Status toggled successfully', 'is_active' => $item->is_active]);
    }
}
